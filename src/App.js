...
export default function App() {
  ...
  // });
  // useEffect(function () {
  //   console.log("After in itial render");
  // }, []);
  // useEffect(function () {
    ...
    <>
      ...
      <Main>
        <Box movies={movies}>
          ...
          {isLoading && <Loader />}{" "}
          {!isLoading && !error && (
            <MovieList movies={movies} onSlectMovie={handleSelectMovie} />
          )}
...
function MovieList({ movies, onSlectMovie }) {
  return (
...
function Movie({ movie, onSlectMovie }) {
  return (
    <li onClick={() => onSlectMovie(movie.imdbID)}>
...
function MovieDetail({ selectedId, onCloseMovie, onAddWatched, watched }) {
  ...
  //we dont want to update the ref in render logic so usefeffct
  useEffect(
    function () {
